...
void EncyclopediaDetailPanel::Refresh() {
    ...
    if (m_part) {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions") && !m_part->Effects().empty()) {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions") && !m_hull->Effects().empty()) {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions") && !m_tech->Effects().empty()) {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions") && !m_building->Effects().empty()) {
